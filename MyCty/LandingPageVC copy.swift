...
//var agenda = [[String]]()
//var agenda:[[String]] = [[]]
/// var agenda: [[AnyObject]] = [["" as AnyObject, "" as AnyObject, "" as AnyObject, "" as AnyObject]]
...
// old working code
       ...
       //agenda.append(Agenda(category: cell.categoryLabel.text!, time: cell.time.text!, date: cell.bigDateLabel.text!, description: cell.descriptionLabel.text!))
         //Agenda.init(category: cell.categoryLabel.text!, time: cell.time.text!, date: cell.smallDateLabel.text!, description: cell.descriptionLabel.text!)
      ...
      /*
      cell.categoryLabel.text = agenda[0][0] as? String
        cell.descriptionLabel.text = agenda[0][1] as? String
        cell.time.text = agenda[0][2] as? String
        cell.bigDateLabel.text = agenda [0][3] as? String
        cell.smallDateLabel.text = agenda[0][3] as? String
*/
