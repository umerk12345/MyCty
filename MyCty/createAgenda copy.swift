        ...
        //  var newAgenda = [[Agenda]]()
         //   newAgenda.append([])
          ...
          //  let createdAgenda = [["", "", "", ""]]
            ...
            /*
            for items in agenda[0]{
                
                var createAgenda = [items]
                createAgenda = [categoryTextField.text!, descriptionField.text!, timeTextField.text!, dateTextField.text!]
                agenda.append(createAgenda)
                
                */
         /*   let second = [Agenda.init(things: categoryTextField.text as AnyObject), Agenda.init(things: timeTextField.text as AnyObject) ,Agenda.init(things: dateTextField.text as AnyObject), Agenda.init(things: descriptionField.text as AnyObject) ]
            
            categoryTextField.text! = agenda[0][0] as! String
            timeTextField.text! = agenda[0][1] as! String
            dateTextField.text! = agenda[0][2] as! String
            descriptionField.text = agenda[0][3] as! String
            
                     agenda.append(second)
 */
