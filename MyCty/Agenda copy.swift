...
class Agenda {
   ...
   /*
    init(things: AnyObject) {
        
        if var createdCategory = category as? String  {
            self._category = createdCategory
            createdCategory = agenda[0][0] as! String
        }
        
        if var createdTime = time as? String  {
            self._time = createdTime
            createdTime = agenda[0][1] as! String
        }
        
        if var createdDate = date as? String  {
            self._date = createdDate
            createdDate = agenda[0][2] as! String
        }
        
        if var createdDescription = description as? String {
            self._description = createdDescription
            createdDescription = agenda[0][3] as! String
